...
func (m *MockIdentityManagementAPIClient) ListConsents(ctx context.Context, in *identityv1beta2.ListConsentsRequest, opts ...grpc.CallOption) (*identityv1beta2.ListConsentsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
